...
<header class="header">
      ...
      <nav class="header__nav">
         ...
         <li class="header__list">
            ...
            <li><a class="header__link btn1" href="customers.php">Customers</a></li>
            <li>
				...
				<?php
					...
					while($row=mysqli_fetch_array($query)){
                     ...
                     <td><?php echo $row['address']; ?></td>
							<td class="margin">
                        <a class="foto" href="delete.php?id=<?php echo $row['id']; ?>"><img src="../image/customers/delete.png" alt=""></a>
								<a class="foto" href="edit.php?id=<?php echo $row['id']; ?>"><img src="../image/customers/edit.png" alt=""></a>
							   <a class="add" href="dodaj.php?id=<?php echo $row['id']; ?>"><img src="../image/customers/add.png" alt=""></a>
                     </td>
						</tr>
						<?php
					}
